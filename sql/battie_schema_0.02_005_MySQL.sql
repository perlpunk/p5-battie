...
-- Created on Sat Feb 25 19:13:51 2012
-- 
...
CREATE TABLE `TABLE_PREFIX_poard_thread` (
  ...
  `mtime` datetime NOT NULL,
  `ctime` datetime NOT NULL,
  INDEX `TABLE_PREFIX_poard_thread_idx_board_id` (`board_id`),
  PRIMARY KEY (`id`),
  CONSTRAINT `TABLE_PREFIX_poard_thread_fk_board_id` FOREIGN KEY (`board_id`) REFERENCES `TABLE_PREFIX_poard_board` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB;
...
CREATE TABLE `TABLE_PREFIX_poard_message` (
  ...
  `changelog` integer(1) NOT NULL DEFAULT 0,
  `has_attachment` integer(1) NOT NULL DEFAULT 0,
  `lft` integer(10),
  `rgt` integer(10),
  ...
  `mtime` datetime NOT NULL,
  `ctime` datetime NOT NULL,
  INDEX `TABLE_PREFIX_poard_message_idx_thread_id` (`thread_id`),
  PRIMARY KEY (`id`),
  CONSTRAINT `TABLE_PREFIX_poard_message_fk_thread_id` FOREIGN KEY (`thread_id`) REFERENCES `TABLE_PREFIX_poard_thread` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB;
...
CREATE TABLE `TABLE_PREFIX_poard_notify` (
  ...
  `ctime` datetime NOT NULL,
  INDEX `TABLE_PREFIX_poard_notify_idx_thread_id` (`thread_id`),
  PRIMARY KEY (`id`),
  UNIQUE `poard_notify_user_id_thread_id` (`user_id`, `thread_id`),
  CONSTRAINT `TABLE_PREFIX_poard_notify_fk_thread_id` FOREIGN KEY (`thread_id`) REFERENCES `TABLE_PREFIX_poard_thread` (`id`)
) ENGINE=InnoDB;
...
CREATE TABLE `TABLE_PREFIX_poard_read_messages` (
  ...
  `mtime` datetime NOT NULL,
  `meta` text,
  INDEX `TABLE_PREFIX_poard_read_messages_idx_thread_id` (`thread_id`),
  PRIMARY KEY (`user_id`, `thread_id`),
  CONSTRAINT `TABLE_PREFIX_poard_read_messages_fk_thread_id` FOREIGN KEY (`thread_id`) REFERENCES `TABLE_PREFIX_poard_thread` (`id`)
) ENGINE=InnoDB;
...
CREATE TABLE `TABLE_PREFIX_survey` (
  ...
  `status` ENUM('onhold','active','deleted','closed') NOT NULL DEFAULT 'onhold',
  `mtime` datetime NOT NULL,
  `ctime` datetime NOT NULL,
  INDEX `TABLE_PREFIX_survey_idx_thread_id` (`thread_id`),
  PRIMARY KEY (`id`),
  CONSTRAINT `TABLE_PREFIX_survey_fk_thread_id` FOREIGN KEY (`thread_id`) REFERENCES `TABLE_PREFIX_poard_thread` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB;
...
CREATE TABLE `TABLE_PREFIX_survey_option` (
  ...
  `mtime` datetime NOT NULL,
  `ctime` datetime NOT NULL,
  INDEX `TABLE_PREFIX_survey_option_idx_survey_id` (`survey_id`),
  PRIMARY KEY (`id`),
  UNIQUE `survey_option_position_survey_id` (`position`, `survey_id`),
  CONSTRAINT `TABLE_PREFIX_survey_option_fk_survey_id` FOREIGN KEY (`survey_id`) REFERENCES `TABLE_PREFIX_survey` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB;
...
CREATE TABLE `TABLE_PREFIX_survey_vote` (
  ...
  `ctime` datetime NOT NULL,
  `meta` text NOT NULL,
  INDEX `TABLE_PREFIX_survey_vote_idx_survey_id` (`survey_id`),
  PRIMARY KEY (`id`),
  UNIQUE `survey_vote_user_id_survey_id` (`user_id`, `survey_id`),
  CONSTRAINT `TABLE_PREFIX_survey_vote_fk_survey_id` FOREIGN KEY (`survey_id`) REFERENCES `TABLE_PREFIX_survey` (`id`)
) ENGINE=InnoDB;
...
-- 
-- Created by SQL::Translator::Producer::MySQL
-- Created on Sat Feb 27 17:53:06 2010
-- 
SET foreign_key_checks=0;
...
-- 
-- Created by SQL::Translator::Producer::MySQL
-- Created on Mon Mar 16 21:39:11 2009
-- 
SET foreign_key_checks=0;
...
CREATE TABLE `TABLE_PREFIX_theme` (
  ...
  `is_news` integer(1) NOT NULL DEFAULT '0',
  `can_comment` integer(1) NOT NULL DEFAULT '0',
  `mtime` datetime NOT NULL,
  `ctime` datetime NOT NULL,
  INDEX (`blog_id`),
  PRIMARY KEY (`id`),
...
CREATE TABLE `TABLE_PREFIX_au_session` (
  ...
  `user_id` bigint(20),
  `data` text,
  `ctime` integer(11) NOT NULL DEFAULT 0,
...
CREATE TABLE `TABLE_PREFIX_poard_user` (
  `id` bigint(20) NOT NULL auto_increment,
  `group_id` integer(10) NOT NULL DEFAULT 0,
  `extra_roles` tinyint(1) NOT NULL DEFAULT 0,
  `active` tinyint(1) NOT NULL DEFAULT 0,
...
CREATE TABLE `TABLE_PREFIX_role_action` (
  ...
  INDEX `TABLE_PREFIX_role_action_idx_role_id` (`role_id`),
  PRIMARY KEY (`id`),
  CONSTRAINT `TABLE_PREFIX_role_action_fk_role_id` FOREIGN KEY (`role_id`) REFERENCES `TABLE_PREFIX_role` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB;
...
CREATE TABLE `TABLE_PREFIX_user_role` (
  ...
  `mtime` datetime NOT NULL,
  `ctime` datetime NOT NULL,
  INDEX `TABLE_PREFIX_user_role_idx_role_id` (`role_id`),
  INDEX `TABLE_PREFIX_user_role_idx_user_id` (`user_id`),
  PRIMARY KEY (`role_id`, `user_id`),
  CONSTRAINT `TABLE_PREFIX_user_role_fk_role_id` FOREIGN KEY (`role_id`) REFERENCES `TABLE_PREFIX_role` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `TABLE_PREFIX_user_role_fk_user_id` FOREIGN KEY (`user_id`) REFERENCES `TABLE_PREFIX_poard_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB;
...
CREATE TABLE `TABLE_PREFIX_message_recipient` (
  ...
  `has_read` tinyint(1) NOT NULL,
  INDEX `TABLE_PREFIX_message_recipient_idx_message_id` (`message_id`),
  INDEX `TABLE_PREFIX_message_recipient_idx_recipient_id` (`recipient_id`),
  UNIQUE `message_recipient_message_id_recipient_id` (`message_id`, `recipient_id`),
  CONSTRAINT `TABLE_PREFIX_message_recipient_fk_message_id` FOREIGN KEY (`message_id`) REFERENCES `TABLE_PREFIX_pm` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `TABLE_PREFIX_message_recipient_fk_recipient_id` FOREIGN KEY (`recipient_id`) REFERENCES `TABLE_PREFIX_poard_user` (`id`)
) ENGINE=InnoDB;
